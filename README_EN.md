...
- **Batch playback control**: play all / pause all / restart all / loop / global mute, applied to all video items; HTML pages keep their own runtime rhythm and are never timeline-controlled.
